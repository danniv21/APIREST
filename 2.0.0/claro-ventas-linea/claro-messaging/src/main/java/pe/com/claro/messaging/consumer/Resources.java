/*package pe.com.claro.messaging.consumer;
...
public class Resources {
    ...
    public static final String ASYNC_QUEUE = "jms/DemoQueueRemote";
    public static final String CLASSIC_QUEUE = "jms/DemoQueueRemote";
}
*/